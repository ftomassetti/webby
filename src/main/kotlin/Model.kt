package me.tomassetti.webby.ast
...
data class WebbyFile(val statements : List<TopLevelElement>, override val position: Position? = null) : Node

interface TopLevelElement : Node { }
